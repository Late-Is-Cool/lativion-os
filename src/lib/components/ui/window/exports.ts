...
export { default as Scalable } from './WindowScalable.svelte';
export { default as Footer } from './WindowFooter.svelte';
export { default as TabList } from './tablist/WindowTablist.svelte';
export { default as TabListContainer } from './tablist/WindowTablistContainer.svelte';
